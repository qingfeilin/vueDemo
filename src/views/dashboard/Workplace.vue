      ...
      <a-row class="more-info">
        <a-col :span="6">
          <!-- <router-link to="/scene">
            <head-info title="场景" content="test" :center="false" :bordered="false"/>
          </router-link> -->
          <router-link to="/scene-designer">
            <head-info title="场景设计器" content="test" :center="false" :bordered="false"/>
          </router-link>
        </a-col>
        <a-col :span="6">
