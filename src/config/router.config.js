...
export const asyncRouterMap = [
      ...
      // dashboard
      {
        ...
        children: [
          ...
          },
          {
            path: 'demo',
            name: 'Demo',
            component: () => import('@/views/demo/EchartsMap'),
            meta: { title: 'echartMap', keepAlive: false, permission: [ 'dashboard' ] }
          }
        ]
      },
      ...
      // account
      {
        ...
        children: [
          ...
          },
          {
            ...
            meta: { title: 'MyBlog', hidden: true, keepAlive: true, permission: [ 'user' ] }
          }
        ]
      },
  ...
  },
  {
    path: '/scene',
    name: 'scene',
    component: () => import('@/views/dataview/Scene'),
    meta: { title: '场景页', keepAlive: true }
  },
  {
    path: '/scene-designer',
    name: 'scene-designer',
  ...
  },
  {
    ...
    component: () => import('@/views/dataview/ComponentEditor'),
    meta: { title: '组件编辑页', keepAlive: true }
  }
]
