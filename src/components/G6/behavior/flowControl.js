  ...
  options: {
    ...
    onNodeMousedown (event) {
      ...
      if (_t.info.target && _t.info.target.attr('name')) {
        ...
        _t.setAchorState('hover', false, event.item)
      }
    ...
    onNodeMouseenter (event) {
      let _t = this
      _t.setAchorState('hover', true, event.item)
    },
    onNodeMouseup (event) {
      let _t = this
    ...
    setAchorState (state, value, item) {
      utils.anchor.setState(state, value, item)
    }
  }
}
